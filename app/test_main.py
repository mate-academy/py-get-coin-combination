...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "17 common sum should be convert to 2 penny and 1 nickel and 1 dimes [2, 1, 1, 0]",
        "50 common sum should be convert to 2 quarters [0, 0, 0, 2]",
        "67 common sum should be convert to 2 penny and 1 nickel and 1 dimes and 2 quarters [2, 1, 1, 2]",
    ],
)
