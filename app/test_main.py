...
def test_returns_correct_change():
...
def test_returns_coins_of_different_denominations():
    assert sum(get_coin_combination(99)) == 99


def test_returns_coins_of_different_types():
