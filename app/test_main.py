...
def test_should_return_all_types_of_coins() -> None:
    assert get_coin_combination(66) == [1, 1, 1, 2]


def test_combinations_less_than_100() -> None:
    assert get_coin_combination(6) == [1, 1, 0, 0]
    assert get_coin_combination(30) == [0, 1, 0, 1]
    assert get_coin_combination(99) == [4, 0, 2, 3]


def test_combinations_greater_than_100() -> None:
...
def test_with_basic_cases() -> None:
    assert get_coin_combination(0) == [0, 0, 0, 0]
